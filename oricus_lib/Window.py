...
import logging
logger = logging.getLogger('oricus_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by OricusWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseOricusWindow object.
        """
        builder = get_builder('OricusWindow')
        new_object = builder.get_object("oricus_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a OricusWindow object with it in order to finish
        initializing the start of the new OricusWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.oricus")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('oricus')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for oricus."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for oricus."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the OricusWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the OricusWindow is closed."""
